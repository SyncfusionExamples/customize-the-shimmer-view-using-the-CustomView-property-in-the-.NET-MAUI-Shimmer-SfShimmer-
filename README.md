# Customize the Shimmer using the CustomView Property in the .NET MAUI Shimmer (SfShimmer)
This repository contains a sample of how to customize the shimmer using the CustomView property in the [.NET MAUI Shimmer (SfShimmer)](https://help.syncfusion.com/maui/shimmer/getting-started) 
